          ...
          <div className="max-w-6xl">
            ...
            <div className="flex flex-col md:flex-row items-center justify-items-center justify-between mb-8">
              <p className="text-gray-500 sm:text-lg md:text-xl font-light md:w-3/4 w-full text-justify">
                <strong className="text-text-danger font-bold">{userData.name}</strong>, es una Startup joven que nos dedicamos a la venta de soluciones para productos StarLinkg, trabajamos con mercadolibre, andreani para quienes quieren envios y puede adquirir cualquiera de nuestros productos por la web.
              </p>
