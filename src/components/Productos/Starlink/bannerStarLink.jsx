...
export default function StarlinkMiniBanner() {
  return (
    <section  className="flex bg-gradient-to-b from-blue-800 to-blue-400 p-4 shadow-lg items-center justify-center" aria-label="Banner de Fuente Adaptador para Antena Starlink Mini">
      <article className="flex justify-between max-w-6xl w-full" role="region"  aria-labelledby="banner-heading" >
        <div className="flex w-full flex-col md:flex-row items-center">
          <div className="mb-4 md:mb-0 md:mr-6 items-center text-center md:text-start">
            ...
            <p className="text-blue-100 mb-4 text-sm md:text-base">Elevador de tension Trifix SL1230 - Potencia y estabilidad para tu conexión satelital</p>
